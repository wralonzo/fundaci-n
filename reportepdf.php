      ...
      <section>
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                <form action="DescargarReporte_x_fecha_PDF.php" method="post" accept-charset="utf-8">
                  <div class="row">
                    <div class="col">
                      <input type="date" name="fecha_nacimiento" class="form-control"  placeholder="Fecha de Inicio" required>
                    </div>
                    <div class="col">
            ...
            <div class="table-responsive resultadoFiltro">
              ...
              <?php
              include('config.php');
              $sqlTrabajadores = ('SELECT * FROM usuario ORDER BY fecha_nacimiento ASC');
              ...
              $i =1;
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $dataRow['dpi'] ; ?></td>
                    <td><?php echo $dataRow['fecha_nacimiento'] ; ?></td>
                </tr>
                </tbody>
              <?php } ?>
              </table>
